...
🤳 También te van a pedir tomarte una selfie ese día — prepárate.`;
  ...
  const upsell = esFree
    ? `\n\nActualmente tienes el plan Gratis. Con VIP ($100 MXN, 14 días) además de Telegram recibes correo y una llamada automática en cuanto abra tu municipio — más posibilidades de enterarte a tiempo. Súbete aquí: ${SITE_URL}`
    : '';
